...
#SBATCH --error=slurm_logs/combine_detectors.err # standard error file
#SBATCH --output=slurm_logs/combine_detectors.out # standard output file
...
python eval_combine_detectors.py
deactivate
