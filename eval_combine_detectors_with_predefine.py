...
from utils.utils import get_project_root, compute_weighted_scores, compute_metrics, combine_anomaly_scores, \
	compute_weighted_scores_based_on_predefined_top_k


def eval_combine_multiple_detectors_with_predefine_selected_detectors(combine_detector_evaluation_config,
																	  merged_df
...
def main(cfg: DictConfig) -> None:
	...
	construct_baseline_cfg = combine_detector_evaluation_config.construct_baseline
	first_metric = construct_baseline_cfg.first_metric
